...

{
  ...
  home.packages = with pkgs; [
      ...
      saxon
      scons
      (texlive.combine { inherit (texlive) scheme-tetex needspace titlesec titlepic fontspec latexmk dvisvgm wrapfig capt-of chktex lipsum minted fvextra upquote catchfile xstring; })
      tree
      unar
      unzip
      vagrant
